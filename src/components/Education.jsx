...
<motion.div style={{scaleY: scrollYProgress}}
    className="absolute left-9 top-0 w-[4px] h-full bg-dark origin-top dark:bg-light md:w-[2px] md:left-[30px] xs:left-[20px]" />
                ...
                <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
                    <Details                     
                   type="Advance Diploma of Computer Programming & Analysis" time="2020-2023"
                   place="Conestoga College, Canada" 
                   info="Relevent Courses included Java Programming, Mobile Application, Game Programming, System Analysis & Design,
                   Data Analysis, Microsoft Enterprise and many more."                                       
                    />
                    <Details                     
                   type="High School" time="2017-2019"
