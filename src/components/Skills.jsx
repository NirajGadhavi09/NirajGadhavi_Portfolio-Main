    ...
    return (
        <>
            ...
            sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
                ...
                <Skill name="C#" x="-25vw" y="-15vw" />
                <Skill name="Web Design" x="15vw" y="-12vw" />
                <Skill name="Python" x="32vw" y="-1vw" />
                <Skill name=".Net" x="0vw" y="-20vw" />
                <Skill name="SQL" x="-22vw" y="16vw" />
                <Skill name="NoSQL" x="18vw" y="18vw" />
                <Skill name="NextJs" x="-33vw" y="-1vw" />
                <Skill name="Angular" x="-33vw" y="10vw" />
                <Skill name="Tailwind CSS" x="-22vw" y="-10vw" />
