    ...
    return (
        ...
        dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8 '>
           ...
           <div className='w-full flex justify-between items-center lg:hidden'>
            ...
            <nav className="flex items-center justify-center fleex-wrap">
                <motion.a href="https://github.com/NirajGadhavi09" target = {"_blank"}
                whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3"><GithubIcon /></motion.a>
                <motion.a href="https://www.linkedin.com/in/niraj-gadhavi09/" target = {"_blank"}
...

            {
                ...
                -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-empty
                py-32'>
                ...
                <button onClick={() => setMode(mode === "light" ? "dark" : "light")}
                className={`ml-3 flex items-center justify-between rounded-full p-1 w-6 mx-3
                ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}`}>
                    {
                        mode === 'dark' ? <SunIcon className={"fill-dark"} />
                        : <MoonIcon className={"fill-dark"} />
